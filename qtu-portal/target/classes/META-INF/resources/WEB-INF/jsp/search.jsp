...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<a href="javascript:void(0)" class="current">1</a>
		<a href="query?q=${query}&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2">2</a>
	<a href="query?q=${query}&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=3">3</a>
	<a href="query?q=${query}&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=4">4</a>
	<a href="query?q=${query}&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=5">5</a>
	<a href="query?q=${query}&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=6">6</a>
	<span class="text">…</span>
	<a href="query?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2" class="next">下一页<b></b></a>
