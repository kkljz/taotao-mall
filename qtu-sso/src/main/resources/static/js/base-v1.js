 ...
 */
function login() {
    return location.href = "http://localhost:8044/login";
}
function regist() {
    return location.href = "http://localhost:8044/register";
}
...
function search(a) {
    var b = "http://www.qtu.com/search/query?q=" + encodeURIComponent(document.getElementById(a).value);
